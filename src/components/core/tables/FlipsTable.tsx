...
const FlipsTable = (props: FlipsProps) => {
  ...
  return (
    <>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell align="center">
                <div className="table__cell-container">
                  {' '}
                  {props.fermentationPhase?.hoursDrained}{' '}
                </div>
              </TableCell>
            ...
            <TableRow>
              ...
              <TableCell align="center">
                <div className="table__cell-container">
                  {' '}
                  {props.fermentationPhase?.initialTemp}{' '}
                </div>
              </TableCell>
              {props.fermentationPhase?.flips?.map((row, index) => {
                return (
            ...
            <TableRow>
              ...
              <TableCell align="center">
                <div className="table__cell-container">
                  {' '}
                  {props.fermentationPhase?.roomTemp}{' '}
                </div>
              </TableCell>
              {props.fermentationPhase?.flips?.map((row, index) => {
                return (
            ...
            <TableRow>
              ...
              <TableCell align="center">
                <div className="table__cell-container">
                  {' '}
                  {props.fermentationPhase?.humidity}{' '}
                </div>
              </TableCell>
              {props.fermentationPhase?.flips?.map((row, index) => {
                return (
                    ...
                    return (
                      <TableCell key={index} align="center">
                        <div className="table__cell-container">
                          <button
                            className="batch-action"
                            onClick={() => handleOpenEditModal(index, row)}
                          >
                            <EditIcon />
                          </button>
                        </div>
      ...
      <AddFlipModal
        open={openAddModal}
        fermentationId={props.fermentationPhase.id}
