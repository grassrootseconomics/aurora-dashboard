...
const SalesStage = (props: StageProps) => {
  ...
  return (
    <>
      <ul>
        <li>
          <span>{t('single_batch.buyer_name')} </span>
          <input
        ...
        <li>
          {t('single_batch.negotiation_type')}{' '}
          <input
        ...
        <li>
          {t('single_batch.negotiation_terms')}{' '}
          <input
        ...
        <li>
          {t('single_batch.negotiation_date')}{' '}
          <input
