...
const GeneralStage = (props: GeneralStageProps) => {
    ...
    function handleStage(data: any[], stage: number) {
        ...
        switch(stage) {
            case 0: return;
            case 1: return;
            case 2: batchStats[2] = data; return;
            case 3: batchStats[3] = data; return;
            case 4: batchStats[4] = data; return;
            case 5: batchStats[5] = data; return;
        }
    }
                    ...
                    { batchStats ?
                        {
                            ...
                            2: <FermentationStage batchCode={props.batch.code} index={2} stats={batchStats[2]} update={handleStage} editMode={editMode} />,
                            3: <DryingStage index={3} stats={batchStats[3]} update={handleStage} editMode={editMode} />,
                            4: <StorageStage index={4} stats={batchStats[4]} update={handleStage} editMode={editMode}/>,
                            5: <SalesStage index={5} stats={batchStats[5]} update={handleStage} editMode={editMode}/>
                        }[props.index] : ""
                    } 
                    </div>
                </div>
